...
# Disable hibernation, disabling SafeSleep (speeds up entering sleep mode, and saves disk space)
# http://www.cultofmac.com/227679/save-space-on-your-hard-drive-disable-safesleep-mode-on-your-mac-os-x-tips/
...
# Changes the interval to 30 minutes
